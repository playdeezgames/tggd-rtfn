...
Friend Module DirectionTypes
    Friend ReadOnly Descriptors As IReadOnlyDictionary(Of String, DirectionTypeDescriptor) =
        ...
        {
            New DirectionTypeDescriptor(Business.DirectionType.North, 0, -1),
            New DirectionTypeDescriptor(Business.DirectionType.East, 1, 0),
            New DirectionTypeDescriptor(Business.DirectionType.South, 0, 1),
            New DirectionTypeDescriptor(Business.DirectionType.West, -1, 0)
